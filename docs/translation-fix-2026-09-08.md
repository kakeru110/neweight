...
### ✅ Various dogs 大人 の身幅（2026-09-09 解決）

日本語原文が **M=62cm / L=58cm** とサイズ逆転していた件、ユーザー確認のうえ誤記と確定。
**M=58cm / L=62cm** に入れ替えた（日本語原文・英語翻訳の両方）。

> 参考：同じ着丈(78/80)・肩幅(53/55)・ポリエステル100%の
> 「British Dogs Long Sleeve Shirts(アダルト)」は身幅 **62/65**。
> ボディが同じなら L=65 の可能性もあるので、実寸で確認できるならしておきたい。
